...
- If a surface rebuild replaces buttons, links, or controls with new DOM nodes, the system must preserve or rebind the intended interactions as part of the same change.
