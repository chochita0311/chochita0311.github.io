...
- Use [note-data-contract.md](./note-data-contract.md) for note metadata ownership and generated artifact presence.
- Use [architecture.md](../../project/architecture.md) for runtime placement and regeneration flow.
