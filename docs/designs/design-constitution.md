...
- Typography:
  - Family: `Manrope` remains the core face across display, headline, body, and label roles.
...
- What must stay visually consistent: Dark editorial atmosphere, Manrope hierarchy, tonal layering, spacious note previews, and restrained accent usage.
