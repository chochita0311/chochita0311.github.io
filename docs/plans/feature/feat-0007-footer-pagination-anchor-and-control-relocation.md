...
- Current footer and control styles in [layouts.css](assets/css/layouts.css) and [components.css](assets/css/components.css)
- Current archive runtime in [archive-content.js](assets/js/archive/content.js) and [index-note-detail.js](assets/js/index-note-detail.js)
- Placement reference only in `tmp/sample.html`
