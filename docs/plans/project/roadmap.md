...
- Polish note-detail reading behavior so utility actions, breadcrumb handoff, and section navigation feel deliberate.
...
- Defer the route-boot stabilization pass until after the current note-detail polish work lands.
