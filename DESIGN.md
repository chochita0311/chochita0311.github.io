...
We use **Inter** for UI and body text, **Noto Sans KR** to keep Korean text stable, and self-hosted **Satoshi** for display and title roles. The hierarchy remains unapologetically bold to mimic high-end print journalism.
...
- **Ambient Shadows:** For floating elements (Modals, Dropdowns), use extra-diffused shadows.
  - _Spec:_ `0px 20px 40px rgba(0, 0, 0, 0.4)`.
